 ...
 * the License.
 */
package com.tencentcloud.sdk.live;

import java.security.SecureRandom;

import org.apache.commons.lang3.StringUtils;

import com.tencentcloud.sdk.TencentLiveProperties;
import com.tencentcloud.sdk.live.resp.MixStreamResult;
...
public class TencentLiveTemplate {
	...
	public MixStreamResult createMixStream(String homeStreamName, String awayStreamName, int retryTimes, 
		...
		do {
			...
			isSuccess = StringUtils.isNotBlank(result.getSessionId()) && ++retryTimes < 2;
		} while (isSuccess);
	...
	public boolean stopMixStream(String mixStreamSessionId) {
		if (StringUtils.isNotBlank(mixStreamSessionId)) {
			try {
