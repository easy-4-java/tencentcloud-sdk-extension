...
// CollectionUtils replaced with java.util.Collections

import com.google.common.collect.ImmutableMap;
import com.google.common.collect.Maps;
import com.tencentcloud.sdk.tim.resp.ops.AppInfoResponse;
import com.tencentcloud.sdk.tim.resp.ops.AppIpResponse;
...
public class TencentTimOpsOperations extends TencentTimOperations {
	...
	public AppInfoResponse getAppInfo(List<String> friendItems) {
		Map<String, Object> requestBody = (friendItems == null || friendItems.isEmpty()) ? Maps.newHashMap() : new ImmutableMap.Builder<String, Object>()
