...
import com.tencentcloud.sdk.tim.req.common.MapKV;
import com.tencentcloud.sdk.tim.req.group.GroupInfo;
import com.tencentcloud.sdk.tim.req.group.GroupJoinedQuery;
import com.tencentcloud.sdk.tim.req.group.GroupMember;
import com.tencentcloud.sdk.tim.req.group.GroupMemberImport;
import com.tencentcloud.sdk.tim.req.group.GroupMemberModify;
import com.tencentcloud.sdk.tim.req.group.GroupMemberQuery;
import com.tencentcloud.sdk.tim.req.group.GroupMessage;
import com.tencentcloud.sdk.tim.req.group.GroupMessageImport;
import com.tencentcloud.sdk.tim.req.group.GroupModify;
import com.tencentcloud.sdk.tim.req.group.GroupResponseFilter;
import com.tencentcloud.sdk.tim.req.message.MsgBody;
import com.tencentcloud.sdk.tim.req.message.OfflinePushInfo;
import com.tencentcloud.sdk.tim.resp.group.AppGroupGetResponse;
import com.tencentcloud.sdk.tim.resp.group.GroupChangeOwnerResponse;
import com.tencentcloud.sdk.tim.resp.group.GroupCreateResponse;
import com.tencentcloud.sdk.tim.resp.group.GroupDestoryResponse;
import com.tencentcloud.sdk.tim.resp.group.GroupInfoGetResponse;
import com.tencentcloud.sdk.tim.resp.group.GroupJoinedListGetResponse;
import com.tencentcloud.sdk.tim.resp.group.GroupMemberAccount;
import com.tencentcloud.sdk.tim.resp.group.GroupMemberAddResponse;
import com.tencentcloud.sdk.tim.resp.group.GroupMemberDeleteResponse;
import com.tencentcloud.sdk.tim.resp.group.GroupMemberForbidSendMsgResponse;
import com.tencentcloud.sdk.tim.resp.group.GroupMemberGetResponse;
import com.tencentcloud.sdk.tim.resp.group.GroupMemberImportResponse;
import com.tencentcloud.sdk.tim.resp.group.GroupMemberModifyResponse;
import com.tencentcloud.sdk.tim.resp.group.GroupMemberOnlineNumGetResponse;
import com.tencentcloud.sdk.tim.resp.group.GroupMemberRoleGetResponse;
import com.tencentcloud.sdk.tim.resp.group.GroupMemberShuttedUinResponse;
import com.tencentcloud.sdk.tim.resp.group.GroupModifyResponse;
import com.tencentcloud.sdk.tim.resp.group.GroupMsgGetResponse;
import com.tencentcloud.sdk.tim.resp.group.GroupMsgImportResponse;
import com.tencentcloud.sdk.tim.resp.group.GroupMsgRecallResponse;
import com.tencentcloud.sdk.tim.resp.group.GroupMsgSendResponse;
import com.tencentcloud.sdk.tim.resp.group.GroupMsgUnreadNumResponse;
import com.tencentcloud.sdk.tim.resp.group.GroupSystemNotificationSendResponse;

/**
 * Asynchronous TIM group management operations.
 *
...
public class TencentTimGroupAsyncOperations extends TencentTimGroupOperations {
	...
	* 9、修改群基础资料
	...
	/**
	 * 24、解散群组（群组解散之后将无法恢复，请谨慎调用该接口）
	 * API：https://cloud.tencent.com/document/product/269/1624
	 * @param groupId 群组ID（必填）
	 * @param consumer 响应处理回调函数
	 */
	public void asyncDestoryGroup(String groupId, Consumer<GroupDestoryResponse> consumer) {
		Map<String, Object> requestBody = new ImmutableMap.Builder<String, Object>()
				.put("GroupId", groupId)
				.build();
		this.asyncRequest(TimApiAddress.DESTROY_GROUP, requestBody, GroupDestoryResponse.class, consumer);
	}
	...
	/**
	 * 52、获取直播群在线人数：App 管理员可以根据群组 ID 获取直播群在线人数。
